#!/usr/bin/env python3
"""Star-mode farm: one Aura process, many rewrites, farm.jsonl.

Does not spawn Aura per sample. --rounds caps *attempts* (plant×rewrite
pairs sent to farm:run). Prints keep/observe/illegal counts.
"""
...
def emit_driver(plan: list[tuple[dict, dict, str]]) -> str:
    ...
    lines = [
        ";; generated by scripts/farm.py — one process, star-mode",
        '(require "farm" all:)',
    ]
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        ...
        f"illegal={illegal} mode=star -> {args.out}"
    )
